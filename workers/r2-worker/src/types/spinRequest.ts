// To parse this data:
//
//   import { Convert, SpinRequest } from "./file";
//
//   const spinRequest = Convert.toSpinRequest(json);
//
...
export class ConvertSpinRequest {
  public static toSpinRequest(json: string): SpinRequest {
    return cast(JSON.parse(json), r("SpinRequest"));
  }

  public static spinRequestToJson(value: SpinRequest): string {
    return JSON.stringify(uncast(value, r("SpinRequest")), null, 2);
  }
}
...
const typeMap: any = {
  SpinRequest: o(
    [
      ...
      { json: "stake", js: "stake", typ: 0 },
      { json: "bonusId", js: "bonusId", typ: null },
      { json: "extras", js: "extras", typ: null },
    ],
    false
  ),
  Custom: o(
