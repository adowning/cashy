// To parse this data:
//
//   import { Convert, DailyLogin } from "./file";
//
//   const dailyLogin = Convert.toDailyLogin(json);
//
...
export class Convert {
  public static toDailyLogin(json: string): DailyLogin {
    return cast(JSON.parse(json), r("DailyLogin"));
  }

  public static dailyLoginToJson(value: DailyLogin): string {
    return JSON.stringify(uncast(value, r("DailyLogin")), null, 2);
  }
}
...
const typeMap: any = {
  DailyLogin: o(
    [
      ...
      { json: "prizes", js: "prizes", typ: a(r("Prize")) },
