...
import img_vipemblem_50_74 from '@/assets/vip/image/img_vipemblem_50_74.png'
...
const userNavToggle = computed(() => {
  const { getUserNavBarToggle } = storeToRefs(appBarStore) // Changed: Use appBarStore instance
...
watch(
  ...
  (newValue) => {
    ...
    if (mobileWidth.value > 1280) {
      ...
      appBarWidth.value = refferalAppBarShow.value
        ? 'app-bar-mobile app-bar-position'
        : 'app-bar-mobile'
    }
  },
  { deep: true },
...
watch(currencyList, () => {
  ...
  currencyList.value.forEach((currency) => {
    imageIndex.value.push(
      currencyImages.findIndex((item) => item.name == currency.currency) != -1
        ? currencyImages.findIndex((item) => item.name == currency.currency)
        : 0,
    )
  })
})
    ...
    <div v-if="token != undefined">
      <div class="d-flex align-center">
              ...
              <reka-list-item class="deposit-item user-card-height pr-1" v-bind="props">
                <div class="d-flex align-center">
                  ...
                  >
                    ...
                    <reka-list theme="dark" bg-color="#1D2027" class="px-2" width="427px">
                      <reka-list-item
                  ...
                  <div class="deposit-icon-bg cursor-pointer relative" @click="depositDialogShow">
                    ...
                    />
                    <div class="text-700-12 white deposit-text-position">Deposit</div>
                  </div>
                </div>
              </reka-list-item>
            </reka-card>
                ...
                <div class="d-flex align-center">
                  ...
                  <div class="m-deposit-icon-bg cursor-pointer relative" @click="depositDialogShow">
                    <img
                      ...
                      width="20"
                    />
                    <div class="text-700-8 white m-deposit-text-position">Deposit</div>
                  </div>
                </div>
              </div>
            </reka-card>
        ...
        <reka-menu offset="20" class="user-menu" :scrim="true">
          ...
          <reka-list theme="dark" bg-color="#1D2027" class="px-2" width="320">
            <reka-list-item class="user-item" value="id">
              ...
              <reka-list-item-title class="ml-2">ID: {{ userInfo.id }}</reka-list-item-title>

              >
              <template v-slot:append>
                <img
                  @click="inviteUrlCopy(userInfo.id)"
            ...
            <reka-list-item class="user-item" value="vip">
              ...
              <reka-list-item-title class="ml-2">
                ...
                <div class="deposit-progress-bg">
                  <div class="d-flex">
                    <div class="white">Wager</div>
                    <div class="ml-auto">
                      <font>R$ 5642</font> / <font color="#623AEC">R$ 10000</font>
                    </div>
                  </div>
                  <div>
                    <reka-progress-linear v-model="depositRate" height="18" class="wager-progress">
                    </reka-progress-linear>
                  </div>
                </div>
              </reka-list-item-title>
            </reka-list-item>
            <reka-list-item class="user-item" value="account" router :to="{ name: 'Account' }">
              <template v-slot:prepend>
                <img src="@/assets/public/svg/icon_public_59.svg" />
              </template>
              <reka-list-item-title class="ml-2"> Account </reka-list-item-title>
            </reka-list-item>
            ...
            <reka-list-item class="user-item" value="bonuses" @click="goBonusPage">
              ...
              <reka-list-item-title class="ml-2"> Bonuses </reka-list-item-title>
            </reka-list-item>
            <reka-list-item class="user-item" value="game_history" @click="goGameHistoryPage">
              <template v-slot:prepend>
            ...
            <reka-list-item class="user-item" value="transactions" @click="goTransactionPage">
              <template v-slot:prepend>
            ...
            >
              ...
              <reka-list-item-title class="ml-2"> Refer Friend </reka-list-item-title>
              <template v-slot:append>
                <img
                  ...
                  width="62"
                />
                <p class="refer-friend-text-position">Earn Money</p>
              </template>
            </reka-list-item>
            ...
            <reka-list-item class="user-item app-background" value="app">
              ...
              <reka-list-item-title class="ml-2">App</reka-list-item-title>
              <template v-slot:append>
                <img
                ...
                <p class="app-text-position">Install</p>
              </template>
            </reka-list-item>
            <reka-list-item class="user-item" value="fairness">
              ...
              <reka-list-item-title class="ml-2"> Fairness </reka-list-item-title>
            </reka-list-item>
            <reka-list-item class="user-item" value="rewards">
              <template v-slot:prepend>
                <img src="@/assets/public/svg/icon_public_67.svg" />
              </template>
              <reka-list-item-title class="ml-2"> Rewards </reka-list-item-title>
            </reka-list-item>
            <reka-list-item class="user-item" value="preferences">
              <template v-slot:prepend>
                <img src="@/assets/public/svg/icon_public_68.svg" />
              </template>
              <reka-list-item-title class="ml-2"> Preferences </reka-list-item-title>
            </reka-list-item>
            ...
            <reka-list-item class="user-item" value="statistics">
              ...
              <reka-list-item-title class="ml-2"> Statistics </reka-list-item-title>
            </reka-list-item>
        ...
        <reka-menu class="mail-menu" :scrim="true">
          ...
          <reka-list theme="dark" bg-color="#1D2027" class="px-2" width="400">
            <reka-list-item
              class="mail-item"
