      ...
      <div v-if="wallet && !isLoading" class="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-4">
        ...
        <div class="col-span-2 w-full">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-4">
            ...
            <div
              class="flex items-center bg-white dark:bg-gray-800 px-4 py-2 shadow-lg w-full mb-3 dark:border-gray-700"
            >
              <div class="w-20 mr-3">
          ...
          <div class="flex shadow dark:bg-gray-800 dark:border-gray-700 w-full rounded-lg">
            ...
            <div class="flex flex-col justify-center p-4">
              ...
              <p class="text-gray-500">
                Nossa plataforma dispõe de um painel de afiliados avançado, permitindo que você
                visualize detalhes sobre ganhos e perdas. Além disso, oferece a capacidade de
                adicionar subafiliados.
              </p>
              <a href="/affiliate/login" class="mt-4 text-green-500 font-bold"
          ...
          <div class="flex flex-col w-full justify-center p-4">
              ...
              <ul>
                <li class="flex dark:bg-gray-800 shadow rounded-lg aposta-1 w-full p-4 mb-3">
                  <div>
                    ...
                    <p class="text-gray-400 text-sm">
                      <strong class="text-gray-400">Jogo:</strong> Os Jogos Originais
                    </p>
                  </div>
                </li>
                <li class="flex dark:bg-gray-800 shadow rounded-lg aposta-2 w-full p-4 mb-3">
                  <div>
                    <h1 class="font-mono text-4xl font-bold">7%</h1>
                    <p class="text-gray-400 text-sm">
                      <strong class="text-gray-400">Jogo:</strong> slots de terceiros, cassino ao
                      vivo
                    </p>
                  </div>
                </li>
                <li class="flex dark:bg-gray-800 shadow rounded-lg aposta-3 w-full p-4 mb-3">
                  <div>
                    ...
                    <p class="text-gray-400 text-sm">
                      <strong class="text-gray-400">Jogo:</strong> Esportes
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div class="mt-5 ml-4">
              <ul class="list-outside list-disc">
                ...
                <li class="mb-3">
                  Nossa decisão de fazer uma aposta será baseada inteiramente em nosso critério
                  depois que um depósito for feito e uma aposta for feita com sucesso.
                </li>
                <li class="mb-3">
                  As comissões podem ser retiradas em nossa carteira CREDK interna do painel a
                  qualquer momento. (Veja a extração de sua comissão no painel e visualize o saldo
                  na carteira).
                </li>
                <li class="mb-3">Apoiamos a maioria das moedas no mercado.</li>
            ...
            <div class="mt-5 w-full border dark:border-gray-500 p-4 rounded">
              Se você tiver alguma dúvida sobre nossas regras, por favor
              <a href="" class="text-green-500 font-bold"> Contate-nos </a>
            </div>
          </div>
        </div>
      </div>
