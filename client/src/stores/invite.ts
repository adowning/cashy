...
import type * as Invite from 'shared/interface/invite'
...
export const useInviteStore = defineStore('invite', () => {
  ...
  const dispatchUserInvite = async () => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.INVITE_PAGE.INVITE_INFO
  ...
  const dispatchUserInviteHistory = async (formData: Invite.InviteHistoryFormData) => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.INVITE_PAGE.INVITE_HISTORY
    const network: Network = Network.getInstance()
  ...
  const dispatchStatisticsList = async () => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.INVITE_PAGE.STATISTICS_LIST
    const network: Network = Network.getInstance()
  ...
  const dispatchInviteAward = async (data: any) => {
    ...
    setSuccess(false)
    const route: string = NETWORK_CONFIG.INVITE_PAGE.INVITER_AWARD
    const network: Network = Network.getInstance()
  ...
  const dispatchInviteSelf = async () => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.INVITE_PAGE.INVITE_SELF
    const network: Network = Network.getInstance()
  ...
  const dispatchInviteHistoryCfg = async () => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.INVITE_PAGE.INVITE_HISTORY_CONFIG
    const network: Network = Network.getInstance()
