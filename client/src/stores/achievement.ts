...
import * as Achievement from 'shared/interface/achievement'
...
export const useAchievementStore = defineStore('achievement', () => {
  ...
  const dispatchAchievementList = async () => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.ACHIEVEMENT_PAGE.ACHIEVEMENT_LIST
  ...
  const dispatchAchievementConfig = async () => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.ACHIEVEMENT_PAGE.ACHIEVEMENT_CONFIG
    const network: Network = Network.getInstance()
  ...
  const dispatchStageAward = async (data: any) => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.ACHIEVEMENT_PAGE.STAGE_AWARD
    const network: Network = Network.getInstance()
  ...
  const dispatchAchievementAward = async (data: any) => {
    setSuccess(false)
    const route: string = NETWORK_CONFIG.ACHIEVEMENT_PAGE.ACHIEVEMENT_AWARD
    const network: Network = Network.getInstance()
