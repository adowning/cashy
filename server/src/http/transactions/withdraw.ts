...
export async function submitWithdrawal(req: BunRequest, user: User): Promise<Response> {
...
export async function getWithdrawalHistory(req: BunRequest, user: User): Promise<Response> {
