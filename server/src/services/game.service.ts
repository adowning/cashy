 ...
 * @returns Response
 */
export async function getGameEnter(req: HonoRequest, user: Partial<User>): Promise<Response> {
  try {
 ...
 * @returns Response
 */
export async function getGameFavoriteGame(req: HonoRequest, user: Partial<User>): Promise<Response> {
  try {
 ...
 * @returns Response
 */
export async function getGameFavoriteGameList(req: HonoRequest): Promise<Response> {
  try {
